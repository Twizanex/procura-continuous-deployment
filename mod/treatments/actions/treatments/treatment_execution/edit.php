...
/**
 * actions/treatment_execution/edit
 * Modifica la ejecución de un tratamento asignado
 */
...
if (!$result) {
    register_error(elgg_echo('treatments:actions:treatment_execution:edit:error'));
} else {
    system_message(elgg_echo('treatments:actions:treatment_execution:edit:ok'));
}
