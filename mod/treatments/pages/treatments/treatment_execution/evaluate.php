...
if ($manage_treatment_execution_permission) {
    ...
    forward(REFERRER, elgg_echo('treatments:pages:treatment_execution:evaluate:no_permission'));
}
...
$form = elgg_view_form('treatments/treatment_execution/evaluate', null, $body_vars);
...
if ($popup){
    ...
    echo elgg_view_page('treatments:pages:treatment_execution:evaluate:title', $page);
}
