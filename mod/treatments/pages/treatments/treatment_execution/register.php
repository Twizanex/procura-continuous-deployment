...
if ($execute_treatment_permission) {
    ...
    forward(REFERRER, elgg_echo('treatments:pages:treatment_execution:register:no_permission'));
}
...
$form = elgg_view_form('treatments/treatment_execution/register', null, $body_vars);
...
if ($popup){
    ...
    echo elgg_view_page('treatments:pages:treatment_execution:register:title', $page);
}
