<?php
/*
 * treatments/treatment_execution/evaluate
 * 
...
if ($treatment_execution_entity->not_executed){
    ...
    if ($treatment_execution_entity->user_feedback){
...
// Date_evaluated
$date_evaluated_label = elgg_echo('treatments:forms:treatments_execution:evaluate:date_evaluated');
