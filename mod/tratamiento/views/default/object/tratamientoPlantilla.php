<?php
/**
 * View for tratamiento plantilla objects
 *
 * @package Tratamiento
 */
...
//	}
	if ( (getPerfil(elgg_get_logged_in_user_guid())==="Medico") ||
		...
		$link = '<a href="/tratamiento/asignarPlantilla/'.$tratamiento->guid.'">Asignar tratamiento a partir de plantilla</a>';
		$description = $link . $description;
	}
...
//);
//	var_dump($tratamiento->estadoPrescrito);
